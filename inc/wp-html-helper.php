...
// image default alt
if ( ! function_exists( 'sunshine_img_default_alt' ) ) {
	function sunshine_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'sunshine_img_tag' ) ) {
	function sunshine_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = sunshine_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'sunshine_anchor_tag' ) ) {
	function sunshine_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'sunshine_heading_tag' ) ) {
	function sunshine_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'sunshine_paragraph_tag' ) ) {
	function sunshine_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'sunshine_other_tag' ) ) {
	function sunshine_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'sunshine_button_element ' ) ) {
	function sunshine_button_element( array $args ) {
