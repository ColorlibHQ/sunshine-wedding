...
// enqueue css
function sunshine_common_custom_css(){
    
    wp_enqueue_style( 'sunshine-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= sunshine_opt( 'sunshine_theme_color' ) != '#131313' ? sunshine_opt( 'sunshine_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= sunshine_opt( 'sunshine_book_btn_color' ) != '#131313' ? sunshine_opt('sunshine_book_btn_color') : '';
		$bookBtnHoverBgColor     	= sunshine_opt( 'sunshine_book_btn_hvr_bg_color' ) != '#131313' ? sunshine_opt('sunshine_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = sunshine_opt( 'sunshine_quote_btn_hvr_text_color');
		...
		$menuHoverColor           = sunshine_opt( 'sunshine_header_menu_hover_color' ) != '#808080' ? sunshine_opt('sunshine_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = sunshine_opt( 'sunshine_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = sunshine_opt( 'sunshine_header_drop_menu_bg_color' ) != '#ffffff' ? sunshine_opt('sunshine_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = sunshine_opt( 'sunshine_dropdown_menu_color' ) != '#131313' ? sunshine_opt('sunshine_dropdown_menu_color') : '';
		$dropMenuHovColor         = sunshine_opt( 'sunshine_dropdown_menu_hover_color' ) != '#808080' ? sunshine_opt('sunshine_dropdown_menu_hover_color') : $themeColor;
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .sunshine_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .sunshine_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'sunshine-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'sunshine_common_custom_css', 50 );